          ...
          <div className="max-w-4xl mx-auto">
            ...
            {isComplete && (
              <div className="mt-8 animate-fade-in">
                <div className="text-2xl md:text-4xl text-warmth-300 font-medium tracking-wide">
                  Welcome to your personal headquarters, Chief!
                </div>
                <div className="mt-4 w-32 h-1 bg-gradient-to-r from-warmth-400 to-warmth-600 mx-auto rounded-full animate-pulse" />
              </div>
            )}
          </div>
        )}
